        ...
        <div className="landing-page-ctn">
            <div className='landing-sec-1'>
                <div className='landing-header'>
                    <img src="https://habitica.com/static/img/home-main@3x.23eeafe4.png" alt="pixel rpg group party"/>
            ...
            <div className='landing-sec-2'>
                ...
                <div className='hilight-ctn'>
                    <div className='landing-hilight'>
                        <img className="landing-img" src="https://habitica.com/static/img/track-habits@3x.7293d5cc.png" alt="tasks"/>
                        <div>
                    ...
                    <div className='landing-hilight'>
                        <img src='https://habitica.com/static/img/earn-rewards@3x.acaba17e.png' alt="earn rewards"/>
                        <div>
                    ...
                    <div className='landing-hilight'>
                        <img src="https://habitica.com/static/img/battle-monsters@3x.7cd8d3e0.png" alt="battle monsters" />
                        <div>
            ...
            <div className='landing-sec-3'>
                ...
                <div className='hilight-ctn'>
                    <div className='landing-hilight'>
                        <img src="https://habitica.com/static/img/health-fitness@3x.9676cd74.png" alt="focus on health"/>
                        <div>
                    ...
                    <div className='landing-hilight'>
                        <img src='https://habitica.com/static/img/school-work@3x.d6eb1650.png' alt="focus on school and work"/>
                        <div>
                    ...
                    <div className='landing-hilight'>
                        <img src='https://habitica.com/static/img/much-more@3x.e3ed259a.png' alt="focus on hobbies" />
                        <div>
            ...
            <div className='landing-sec-4'>
                <div>
                    <img src='https://habitica.com/static/img/mobile-preview@3x.422fbec7.png' id="l-4-pic" alt="mobile previews"/>
                </div>
