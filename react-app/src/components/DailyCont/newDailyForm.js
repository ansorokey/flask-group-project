...
function CreateDailyForm() {
  ...
  const [repeats_frame, setRepeats_frame] = useState('1');
  const [repeats_frequency, setRepeats_frequency] = useState('1');
      ...
      <form className="daily-habit-form" onSubmit={handleSubmit}>
        ...
        <div className="edit-form-bottom">
          ...
          <div className="edit-habit-select-ctn">
            ...
            <select
              value={repeats_frame}
              onChange={(e) => setRepeats_frame(e.target.value)}
            >
          ...
          <div className="edit-habit-select-ctn">
            ...
            <div>
              <input
                type="number"
                min="1"
                value={repeats_frequency}
                onChange={(e) => setRepeats_frequency(e.target.value)}
              />
